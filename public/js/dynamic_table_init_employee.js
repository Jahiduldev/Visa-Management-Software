function fnFormatDetails ( oTable, nTr )
{
    ...
    sOut += '<tr><td>Employee Code:</td><td>'+aData[1]+'</td></tr>';
    sOut += '<tr><td>Employee Type:</td><td>'+aData[2]+'</td></tr>';
	 sOut += '<tr><td>Employee Phone:</td><td>'+aData[4]+'</td></tr>';
	  sOut += '<tr><td>Employee Address:</td><td>'+aData[5]+'</td></tr>';
