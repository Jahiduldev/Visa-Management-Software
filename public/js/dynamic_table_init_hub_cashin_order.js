function fnFormatDetails ( oTable, nTr )
{
    ...
    sOut += '<tr><td>Agent Wallet:</td><td>'+aData[2]+'</td></tr>';
    sOut += '<tr><td>Cash Amount:</td><td>'+aData[3]+'</td></tr>';
    sOut += '<tr><td>Transaction Id:</td><td>'+aData[4]+'</td></tr>';
    sOut += '<tr><td>F1 Sms:</td><td>'+aData[5]+'</td></tr>';
    sOut += '<tr><td>Submit DateTime:</td><td>'+aData[6]+'</td></tr>';
    sOut += '<tr><td>Create DateTime:</td><td>'+aData[7]+'</td></tr>';
