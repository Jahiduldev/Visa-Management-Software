                    ...
                    <div class="panel-body">
                        <form class="cmxform form-horizontal tasi-form" id="addPassportForm"  role="form" method="post"  action="<?php echo site_url('create_new/addPassport'); ?>"  enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" class="form-control" placeholder="Enter Passport holder Name" id="add_passport_holder_name" name="add_passport_holder_name" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" class="form-control" placeholder="Enter Passport Number" id="add_passport_no" name="add_passport_no"required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
							  ...
							  <div class="form-group">
                                <label for="inputSuccess" class="col-sm-2 control-label col-lg-2">Biodata</label>
                                <div class="col-lg-10">
                                    <input type="file" name="passport_owner1" size="20" />
                                </div>
                            </div>
							  ...
							  <div class="form-group">
                                <label for="inputSuccess" class="col-sm-2 control-label col-lg-2">Photo</label>
                                <div class="col-lg-10">
                                    <input type="file" name="passport_owner2" size="20" />
                                </div>
                            </div>
