        ...
        <div class="row">
            <div class="col-lg-12">
                <section class="panel">
                    ...
                    <div class="panel-body">
                        <form class="cmxform form-horizontal tasi-form" id="addUserForm"  role="form" method="post"  action="<?php echo site_url('salary_add/addSalaryAdd'); ?>" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <select class="form-control" id="add_type" name="add_type" required> 
                                        ...
                                        <?php
                                        foreach ($get_salary_add_type_data as $row) :
                                            ?>
