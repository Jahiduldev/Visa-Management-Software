    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
			 ...
			 <label for="inputSuccess" class="col-sm-3 control-label col-lg-3">Manpower Name</label>
                        <div class="col-lg-9">
							 ...
							 <input type="text" class="form-control"  id="edit_okala_status" name="edit_okala_status" required="required">
