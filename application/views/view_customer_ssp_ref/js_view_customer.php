<script>
    ...
    $(document).ready(function () {
        ...
        var oTable = $('#editable-sample').dataTable({
            ...
            "ajax": "<?php echo site_url('view_customer/getTableDataRef/?gid='); ?>" + "<?=$ref?>",
            "aoColumns": [
                {"sClass": "center"},
                {"sClass": "center"},
                {"sClass": "center"},
...
function getFlightData(id) {
        $('#editable-sample').dataTable({
            ...
            "serverSide": true,
            "pagingType": "full_numbers",
            "ajax": "<?php echo site_url('view_customer/getTableDataFlight/?fid='); ?>" + id,
    ...
    function editModal(id) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                var basic_flight = ob[0].basic_flight;
                ...
                $("#edit_basic_flight").val(basic_flight);
