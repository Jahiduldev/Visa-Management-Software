                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label for="inputSuccess" class="col-sm-1 control-label col-lg-1">Gender*</label>
                                        <div class="col-lg-3">
                                        ...
                                        <label for="inputSuccess" class="col-sm-1 control-label col-lg-1">Passport Side*</label>
                                        <div class="col-lg-3">
                                        ...
                                        <label for="inputSuccess" class="col-sm-1 control-label col-lg-1">Basic Flight*</label>
                                        <div class="col-lg-3">
                                            <select class="form-control" id="basic_flight" name="basic_flight" onchange="getFlightData(this.value)"> <!-- input-sm m-bot15  -->
                                                <option value="">Select</option>
                                ...
                                <table class="display table table-bordered" id="editable-sample"> <!--hidden-table-info   -->
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="color:blue">SI</th>
                                            <th style="color:blue">NAME</th>
                                            <th style="color:blue">PASSPORT NO.</th>
                                            <th style="color:blue">Create Date</th>
                                             <th style="color:blue">Updated Date</th>
                                            <th style="color:blue">ID NO.</th>
                                            <th style="color:blue">VISA NO.</th>
                                            <th style="color:blue">REFERENCE NAME</th>
                                            <th style="color:blue">BROKER NAME</th>
                                            <th style="color:blue">BROKER MOBILE NUMBER</th>
                                            <th style="color:blue">REFERENCE MOBILE NUMBER</th>
                                            <th style="color:blue">Sponsor Name</th>
                                            <th style="color:blue">GENDER</th>
                                            <th style="color:blue">Passport Side</th>
                                             <th style="color:blue">Basic Flight</th>
                                            <th style="color:blue">Note</th>
