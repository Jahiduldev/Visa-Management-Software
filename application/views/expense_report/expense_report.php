                    ...
                    <div class="panel-body">
                        <div class="adv-table">
                            <table class="display table table-bordered" id="hidden-table-info">
                                ...
                                <tbody>
                                    <?php
                                    foreach ($get_indirect_expense_data as $row) :
                                        $id = $row->id;
                                        ...
                                        $query_1 = $this->db->query("select * from indirect_expense_type where id='$expense_type'");
        ...
        <div class="modal fade" id="myModalEdit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form role="form" class="form-horizontal" method="post" action="<?php echo site_url('expense_report/editMenu'); ?>">
                          
                                    <div class="form-group">
                                <label for="inputSuccess" class="col-lg-3 col-sm-3 control-label">Expense Type*</label>
                                <div class="col-lg-9">
                                    <select class="form-control" id="edit_exp_type_name" name="edit_exp_type_name" required> <!-- input-sm m-bot15  -->
