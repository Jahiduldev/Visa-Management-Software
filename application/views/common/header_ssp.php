...
<html lang="en">
    ...
    <section id="container" >
        ...
        <header class="header white-bg">
            ...
            <!--logo start-->
            <a href="<?php echo site_url('home');  ?>" class="logo"><!--<img width=60px;height=auto; src="<?php //echo $base_url ?>public/img/pizzalogo.png"/>--><span style="color:#009246">Exp</span><span style="color:#CE2B37">lorer</span></a>
            <!--logo end-->
