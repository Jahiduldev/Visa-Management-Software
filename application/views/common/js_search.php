...
<script type="text/javascript" language="javascript" src="<?php echo $base_url ?>public/assets/search_datatable/jquery-1.js">
</script>
<script type="text/javascript" language="javascript" src="<?php echo $base_url ?>public/assets/search_datatable/jquery.js">
</script>
