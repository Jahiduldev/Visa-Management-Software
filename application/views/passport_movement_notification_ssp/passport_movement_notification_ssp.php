            ...
            <div class="col-lg-12">
                <section class="panel">
                    <header class="panel-heading">
                       Passport Movement Notification
                    </header>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" class="form-horizontal" method="post" action="<?php echo site_url('passport_movement_notification/passwordApproved'); ?>">
...
<div class="modal fade" id="rejectModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" class="form-horizontal" method="post" action="<?php echo site_url('passport_movement_notification/passwordRejected'); ?>">
