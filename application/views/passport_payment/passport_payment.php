    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" class="form-horizontal" method="post" action="<?php echo site_url('passport_payment/addPayment'); ?>">
                    ...
                    <div class="form-group">
                        <label for="inputSuccess" class="col-sm-3 control-label col-lg-3">Contact Amount *</label>
                        <div class="col-lg-9">
                            <input type="text" class="form-control"  id="edit_contact_amount" name="edit_contact_amount" required="required">
                        </div>
                    </div>
        ...
        <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <input type="text" class="form-control"  id="edit_payment_amount" name="edit_payment_amount" required="required">
                        </div>
                    </div>
