                    ...
                    <div class="panel-body">
						...
						<!--<div class="row">
                            <div class="col-lg-12">
                                    ...
                                    <div class="col-lg-4">
                                        <select class="form-control" id="gender_type" name="gender_type" onchange="getGenderData(this.value)">  
                                    ...
                                    <div class="col-lg-4">
                                        <select class="form-control" id="passport_type" name="passport_type" onchange="getPassportData(this.value)"> 
                                            <option value="">Select</option>
