...
class Indirect_expense_type extends CI_Controller {
    ...
    public function index() {
        ...
        if (in_array($this->session->userdata('role_id'), $per_role_arr)):
            ...
            $data['active_sub_menu'] = 'Indirect Expense Type';
            $table_name='indirect_expense_type';
            $data['get_indirect_expense_type_data'] = $this->common_model->getData($table_name);
            $this->load->view('common/header',$data);
            $this->load->view('indirect_expense_type/indirect_expense_type',$data);
            $this->load->view('common/footer',$data);
            $this->load->view('common/js',$data);
            $this->load->view('indirect_expense_type/js_indirect_expense_type',$data);
