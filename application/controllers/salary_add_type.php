...
class Salary_add_type extends CI_Controller {
    ...
    public function index() {
        ...
        if (in_array($this->session->userdata('role_id'), $per_role_arr)):
            ...
            $data['active_sub_menu'] = 'Salary Add Type';
            $table_name='salary_add_type';
            $data['get_salary_add_type_data'] = $this->common_model->getData($table_name);
            $this->load->view('common/header',$data);
            $this->load->view('salary_add_type/salary_add_type',$data);
            $this->load->view('common/footer',$data);
            $this->load->view('common/js',$data);
            $this->load->view('salary_add_type/js_salary_add_type',$data);
