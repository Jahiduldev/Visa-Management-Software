...
class Package_delete extends CI_Controller {
    ...
    public function index() {
         if (in_array($this->session->userdata('role_id'), array(1,2))):
            ...
            $data['active_sub_menu'] = 'Delete Tour Package';
            ...
            $this->load->view('package_delete/package_delete',$data);
            $this->load->view('common/footer',$data);
            $this->load->view('common/js',$data);
            $this->load->view('package_delete/js_package_delete',$data);
