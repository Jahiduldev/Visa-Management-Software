...
class Ticket_info extends CI_Controller {
    ...
    public function index() {
        ...
        if (in_array($this->session->userdata('role_id'), array(1,2,3))):
            ...
            $data['active_sub_menu'] = 'Ticket Info';
          

            $this->load->view('common/header',$data);
            $this->load->view('ticket_info/ticket_info',$data);
            $this->load->view('common/footer',$data);
            $this->load->view('common/js',$data);
            $this->load->view('ticket_info/js_ticket_info',$data);
