...
class Income_report extends CI_Controller {
    ...
    public function index() {
        ...
        if (in_array($this->session->userdata('role_id'), $per_role_arr)):
            ...
            $data['active_sub_menu'] = 'Income Report';
            $table_name='indirect_income';
            $data['get_indirect_income_data'] = $this->common_model->getData($table_name);
              $table_name = 'indirect_income_type';
            $data['get_indirect_income_type_data'] = $this->common_model->getData($table_name);
            
            $this->load->view('common/header',$data);
            $this->load->view('income_report/income_report',$data);
            $this->load->view('common/footer',$data);
            $this->load->view('common/js',$data);
            $this->load->view('income_report/js_income_report',$data);
    ...
    public function editMenu() {
        ...
        if (in_array($this->session->userdata('role_id'), $per_role_arr)):
            $data['base_url'] = $this->config->item('base_url');
            $id = mysql_real_escape_string($this->input->post('edit_income_type_id'));
            $income_type = mysql_real_escape_string($this->input->post('edit_income_type_name'));
