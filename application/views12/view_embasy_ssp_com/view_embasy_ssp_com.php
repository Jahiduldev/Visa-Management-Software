    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Edit Embassy Info</h4>
            </div>

            <div class="modal-body">
                <form role="form" class="form-horizontal" method="post" action="<?php echo site_url('view_embasy_com/editModel'); ?>"  enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <img id="pp2" alt="no image found" src="" width="150" height="150"><a id="linkpp2" href="" target="_blank" ></a>
