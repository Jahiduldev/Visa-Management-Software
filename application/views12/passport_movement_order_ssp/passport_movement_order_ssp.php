    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" class="form-horizontal" method="post" action="<?php echo site_url('passport_movement_order/editModel'); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <input type="text" class="form-control" id="edit_passport_side" name="edit_passport_side" readonly="readonly">
                        </div>
                    </div>
                    
                    <div class="form-group">
                        <label for="inputSuccess" class="col-sm-3 control-label col-lg-3">Request Passport Side*</label>
                        <div class="col-lg-9">
                            <select class="form-control" id="change_passport_side" name="change_passport_side"> <!-- input-sm m-bot15  -->
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">  
                            <textarea class="form-control"   id="edit_side_note" name="edit_side_note" required="required"></textarea>
                        </div>
                    </div>
