                    ...
                    <div class="panel-body">
                        <form class="cmxform form-horizontal tasi-form" id="SubMenuForm"  role="form" method="post"  action="#">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-9">  
                                    <input type="text" class="form-control"  value="<?= $visa_type ?>" name="edit_visa_type" value="<?= $edit_visa_type ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-9">
                                    <select class="form-control" name="edit_broker_name" id="edit_broker_name" > <!-- input-sm m-bot15  -->
