    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" class="form-horizontal" method="post" action="<?php echo site_url('view_enjaz_incom/editModel'); ?>">
                    ...
                    <div class="form-group">
                        <label for="inputSuccess" class="col-sm-3 control-label col-lg-3">Flight Date *</label>
                        <div class="col-lg-9">
                    ...
                    <div class="form-group">
                        <label for="inputSuccess" class="col-sm-3 control-label col-lg-3">Flight Number *</label>
                        <div class="col-lg-9">
                    ...
                    <div class="form-group">
                        <label for="inputSuccess" class="col-sm-3 control-label col-lg-3">Flight Note *</label>
                        <div class="col-lg-9">  
