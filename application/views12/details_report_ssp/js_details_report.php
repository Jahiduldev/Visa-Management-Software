...
<script>
    ...
    $(document).ready(function() {
        ...
        var oTable = $('#editable-sample').dataTable({
            ...
            "ajax": '<?php echo site_url('details_report/getTableData'); ?>',
            "aoColumns": [
                {"sClass": "center"},
                {"sClass": "center"},
                {"sClass": "center"},
    ...
    function getGenderData(id) {
        $('#editable-sample').dataTable({
            ...
            "serverSide": true,
            "pagingType": "full_numbers",
            "ajax": "<?php echo site_url('details_report/getTableDataGender/?gid='); ?>"+id,
            "aoColumns": [
                {"sClass": "center"},
                {"sClass": "center"},
                {"sClass": "center"},
    ...
    function getPassportData(id) {
        $('#editable-sample').dataTable({
            ...
            "serverSide": true,
            "pagingType": "full_numbers",
            "ajax": "<?php echo site_url('details_report/getTableDataPassport/?gid='); ?>"+id,
            "aoColumns": [
             {"sClass": "center"},
                {"sClass": "center"},
                {"sClass": "center"},
