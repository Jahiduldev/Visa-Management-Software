...
<html lang="en">
    <head>
        ...
        <title>Explorer Air International </title>
    ...
    <section id="container" >
        ...
        <header class="header white-bg">
            ...
            <!--logo start-->
            <a href="<?php echo site_url('home');  ?>" class="logo"><!--<img width=60px;height=auto; src="<?php //echo $base_url ?>public/img/pizzalogo.png"/>--><span style="color:#009246">Explorer Air International  </span><span style="color:#CE2B37">Admin</span></a>
            <!--logo end-->
