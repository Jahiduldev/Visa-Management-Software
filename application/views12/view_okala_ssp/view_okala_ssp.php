    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Update Manpower</h4>
            </div>

            <div class="modal-body">
                <form role="form" class="form-horizontal" method="post" action="<?php echo site_url('view_okala_incom/editModel'); ?>">
                    ...
                    <div class="form-group">
		        <label for="inputSuccess" class="col-sm-3 control-label col-lg-3">Select Manpower*</label>
		        <div class="col-lg-9">
			
			
			
			  <select class="form-control" name="edit_okala_status" id="edit_okala_status" > <!-- input-sm m-bot15  -->
                                        <option value="">Select Manpower</option>
                                        <?php
										  $table_name = 'broker_table';
                                          $get_broker_data = $this->common_model->getData($table_name);
