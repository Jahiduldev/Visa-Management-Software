                    ...
                    <div class="col-lg-12">
                        <form class="cmxform form-horizontal tasi-form" id="addUserForm" onsubmit="return test()"  role="form" method="post"  action="<?php echo site_url('upload/uploadData');?>" enctype="multipart/form-data">
                            ...
                            <div class="form-group" id="recent_album_div" >
                                <label for="inputSuccess" class="col-sm-2 control-label col-lg-2">Package Ttile </label>
                                <div class="col-lg-10">
                                    <input type="text" class="form-control" name="title" id="recent_album_title"  />
                                </div>
                            </div>
                            <div class="form-group" id="recent_album_div" >
                                <label for="inputSuccess" class="col-sm-2 control-label col-lg-2">Package Country </label>
                                <div class="col-lg-10">
                                    <input type="text" class="form-control" name="country" id="recent_album_title"  />
                                </div>
                            </div>
                            <div class="form-group" id="recent_album_div" >
                                <label for="inputSuccess" class="col-sm-2 control-label col-lg-2">Package Amount </label>
                                <div class="col-lg-10">
                                    <input type="text" class="form-control" name="amount" id="recent_album_title"  />
                                </div>
                            </div>
							 <div class="form-group" id="recent_album_div" >
